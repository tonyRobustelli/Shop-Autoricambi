...
<article class="formofficina">
    ...
    <%
        ...
        StoricoCliente_Manager query = new StoricoCliente_Manager();
        Utente cli = (Utente) session.getAttribute("Utente");
        query.querycliente(cli.getCodiceFiscale());
